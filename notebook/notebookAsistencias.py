...
#Contar cada registro de asistencia por cada estado
conteoRegistrosPorEstado = asistenciaDataFrame.groupby('estado').size()
#Número de registros por estrato
conteoRegistrosPorEstrato = asistenciaDataFrame.groupby('estrato').size()
#Cantidad de estudiantes por medio de transporte
conteoEstudiantesPorMedioTransporte = asistenciaDataFrame.groupby('medio_transporte').size()
#Cantidad de registros por grupo
conteoRegistrosPorGrupo = asistenciaDataFrame.groupby('grupo').size()
#Cruce entre estado y medio de transporte
cruceEstadoMedioTransporte = asistenciaDataFrame.groupby(['estado', 'medio_transporte']).size()